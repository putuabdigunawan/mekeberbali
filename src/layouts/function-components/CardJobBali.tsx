...
import { AiOutlineArrowRight } from 'react-icons/ai'; // Pastikan Anda sudah menginstal library ini atau yang serupa
  ...
  return (
    <div className="mb-8 md:col-6">
      <div className="rounded-xl bg-white p-5 shadow-lg lg:p-10">
        ...
        <p className="mt-6">{posts.excerpt}</p>
