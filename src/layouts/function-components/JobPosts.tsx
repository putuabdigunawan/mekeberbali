...
const JobPosts = ({ posts, categories, career }: JobPostsProps) => {
      ...
      <div className="container">
        <div className="row">
          <div className="mx-auto text-center lg:col-8">
            ...
            <ul className="filter-list mt-8 flex flex-wrap items-center justify-center hidden">
              <li>
                <span
