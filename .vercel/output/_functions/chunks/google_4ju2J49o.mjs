...
function getHeadings() {
  return [{
    "depth": 4,
    "slug": "how-to-connect-your-store-with-google",
    "text": "How to connect your store with Google"
  }];
}
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.h4, {
      id: "how-to-connect-your-store-with-google",
      children: "How to connect your store with Google"
...
const url = "src/content/integrations/google.mdx";
const file = "/Users/user/Documents/all_project/astroboy/pinwheel-astro-main/src/content/integrations/google.mdx";
...
Content.moduleId = "/Users/user/Documents/all_project/astroboy/pinwheel-astro-main/src/content/integrations/google.mdx";
