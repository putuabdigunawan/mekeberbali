...
<a class="text-text-dark" href="/signin">Sign in</a>.
  ...
  ))}</h2> <div class="auth-banner-carousel"> <div class="swiper-container"> <div class="swiper-wrapper"> <div class="swiper-slide"> <img width="667" height="557" class="mx-auto" src="/images/signup-carousel-img-1.png" alt=""> </div> <div class="swiper-slide"> <img width="667" height="557" class="mx-auto" src="/images/signup-carousel-img-1.png" alt=""> </div> <div class="swiper-slide"> <img width="667" height="557" class="mx-auto" src="/images/signup-carousel-img-1.png" alt=""> </div> </div> <div class="relative flex justify-center"> <div class="pagination"></div> </div> </div> </div> </div> </div> </div> </div> </section> ` })} ${renderScript($$result, "/Users/user/Documents/all_project/astroboy/pinwheel-astro-main/src/pages/signup.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/user/Documents/all_project/astroboy/pinwheel-astro-main/src/pages/signup.astro", void 0);

const $$file = "/Users/user/Documents/all_project/astroboy/pinwheel-astro-main/src/pages/signup.astro";
const $$url = "/signup";
