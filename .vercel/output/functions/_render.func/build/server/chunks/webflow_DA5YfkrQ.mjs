...
function getHeadings() {
  return [{
    "depth": 4,
    "slug": "how-to-connect-your-store-with-webflow",
    "text": "How to connect your store with Webflow"
  }];
}
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.h4, {
      id: "how-to-connect-your-store-with-webflow",
      children: "How to connect your store with Webflow"
...
const url = "src/content/integrations/webflow.mdx";
const file = "/Users/user/Documents/all_project/astroboy/pinwheel-astro-main/src/content/integrations/webflow.mdx";
...
Content.moduleId = "/Users/user/Documents/all_project/astroboy/pinwheel-astro-main/src/content/integrations/webflow.mdx";
