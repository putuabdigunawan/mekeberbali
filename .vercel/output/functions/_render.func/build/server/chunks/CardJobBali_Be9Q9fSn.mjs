...
const CardJobBali = ({ posts }) => {
  return /* @__PURE__ */ jsx("div", { className: "mb-8 md:col-6 px-3", children: /* @__PURE__ */ jsxs("div", { className: "rounded-xl bg-white p-5 shadow-lg lg:p-10", children: [
    /* @__PURE__ */ jsx("h3", { className: "h4", children: /* @__PURE__ */ jsx("a", { href: `/lowongan/${posts.slug}`, children: posts.title }) }),
    /* @__PURE__ */ jsx("p", { className: "mt-6", children: posts.excerpt }),
    /* @__PURE__ */ jsxs("ul", { className: "mt-6 flex flex-wrap items-center text-text-dark", children: [
      posts.status && /* @__PURE__ */ jsxs("li", { className: "my-1 mr-8 inline-flex items-center", children: [
        /* @__PURE__ */ jsx(
          "svg",
          {
            className: "mr-1",
