...
function getHeadings() {
  return [{
    "depth": 4,
    "slug": "how-to-connect-your-store-with-twitter",
    "text": "How to connect your store with Twitter"
  }];
}
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.h4, {
      id: "how-to-connect-your-store-with-twitter",
      children: "How to connect your store with Twitter"
...
const url = "src/content/integrations/twitter.mdx";
const file = "/Users/user/Documents/all_project/astroboy/pinwheel-astro-main/src/content/integrations/twitter.mdx";
...
Content.moduleId = "/Users/user/Documents/all_project/astroboy/pinwheel-astro-main/src/content/integrations/twitter.mdx";
