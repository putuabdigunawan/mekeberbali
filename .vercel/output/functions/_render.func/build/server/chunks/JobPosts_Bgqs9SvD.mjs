...
import { h as humanize } from './ClientRouter_Ba-Ivvbk.mjs';
...
const JobPosts = ({ posts, categories, career }) => {
  ...
  return /* @__PURE__ */ jsx("section", { className: "section -mt-20", children: /* @__PURE__ */ jsxs("div", { className: "container", children: [
    /* @__PURE__ */ jsx("div", { className: "row", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto text-center lg:col-8", children: [
      /* @__PURE__ */ jsx("h1", { className: "", children: career?.title }),
      /* @__PURE__ */ jsx(
        "p",
        {
          className: "mt-4",
      ...
      /* @__PURE__ */ jsxs("ul", { className: "filter-list mt-8 flex flex-wrap items-center justify-center hidden", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "row mt-12", children: filterPost.map((post, i) => /* @__PURE__ */ jsx("div", { className: "mb-8 md:col-6", children: /* @__PURE__ */ jsxs("div", { className: "rounded-xl bg-white p-5 shadow-lg lg:p-10", children: [
      /* @__PURE__ */ jsx("h3", { className: "h4", children: /* @__PURE__ */ jsx("a", { href: `/lowongan/${post.id}`, children: post.data.title }) }),
      /* @__PURE__ */ jsx("p", { className: "mt-6", children: post.data.excerpt }),
      /* @__PURE__ */ jsxs("ul", { className: "mt-6 flex flex-wrap items-center text-text-dark", children: [
