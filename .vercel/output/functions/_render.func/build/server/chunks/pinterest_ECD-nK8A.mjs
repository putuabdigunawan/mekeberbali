...
function getHeadings() {
  return [{
    "depth": 4,
    "slug": "how-to-connect-your-store-with-pinterest",
    "text": "How to connect your store with Pinterest"
  }];
}
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.h4, {
      id: "how-to-connect-your-store-with-pinterest",
      children: "How to connect your store with Pinterest"
...
const url = "src/content/integrations/pinterest.mdx";
const file = "/Users/user/Documents/all_project/astroboy/pinwheel-astro-main/src/content/integrations/pinterest.mdx";
...
Content.moduleId = "/Users/user/Documents/all_project/astroboy/pinwheel-astro-main/src/content/integrations/pinterest.mdx";
